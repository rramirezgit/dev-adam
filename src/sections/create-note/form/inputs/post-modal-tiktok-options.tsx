...
const TexAreaContainer = styled(Box)(
  ({ error, theme }: TexAreaContainerProps) => ({
    width: "100%",
    display: "flex",
  ...
  return (
    ...
    >
      <Typography sx={{ fontWeight: 700, fontSize: "14px" }}>
        {t("Dashboard.Create_Nota.Create.Modal.Tiktok_Options")}
      </Typography>
      ...
      <FormGroup>
        <FormControlLabel
          ...
          label={t(
            "Dashboard.Create_Nota.Create.Modal.Switch_Disable_Comments"
          )}
        />
        <FormControlLabel
          control={
          ...
          label={t("Dashboard.Create_Nota.Create.Modal.Switch_Disable_Duo")}
        />
        <FormControlLabel
          control={
            <Switch
          ...
          label={t("Dashboard.Create_Nota.Create.Modal.Switch_Disable_Paste")}
        />
      </FormGroup>
    </Box>
  );
