...
export default function PosModalFormLayout({ children }: IPosModalFormLayout) {
  ...
  return (
    ...
    >
      ...
      >
        {t('Dashboard.Create_Newsletter.Title')}
      </Typography>
      ...
      >
        <Typography sx={{ fontWeight: 400, fontSize: 14 }}>
          {t('Dashboard.Create_Newsletter.Create.Modal.Publish_In')}
        </Typography>
        ...
        >
          {t('Dashboard.Create_Newsletter.Create.Modal.Connect_SocialNetwork')}
        </Link>
      </Box>
