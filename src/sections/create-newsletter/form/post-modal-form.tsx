          ...
          <>
            ...
            >
                  ...
                  title={
                    <>
                      <Typography variant="button" color="inherit">
                        {t('Dashboard.Create_Newsletter.Create.Modal.Tooltip_ToPostIn', {
                          tabSelected,
                        })}
                      </Typography>{' '}
                      <br />
                      <Typography variant="caption" color="inherit">
                        {t('Dashboard.Create_Newsletter.Create.Modal.Tooltip_Activate')}
                      </Typography>
                      <Box
                        sx={{
                          height: 48,
              ...
              {showOverlay && isConected && (
                ...
                >
                  {t('Dashboard.Create_Newsletter.Create.Modal.btn_Post')}
                </Button>
              )}
            </Form>
